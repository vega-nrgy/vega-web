    ...
    <>
      <PageIntro eyebrow="OUR NETWORK" heading="Charging stops built for the road — and the driver.">
        <p className="mt-6 max-w-2xl text-[17px] leading-relaxed text-muted">
          Every Vega Charge station is more than a power socket on a highway. It&rsquo;s a
          rest stop, a service point, and a community hub &mdash; built to global standards,
        ...
        <div className="mx-auto max-w-7xl px-6 pt-14 lg:px-8">
          ...
          <div className="mt-4 flex flex-wrap gap-6">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11.5px] text-muted">Opening 2026 &mdash; site secured</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full border-2 border-white bg-muted-onink shadow-[0_0_0_1px_rgba(157,180,176,0.9)]" />
              <span className="text-[11.5px] text-muted">In land acquisition</span>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="network-cta" labelledBy="network-cta-heading" className="bg-paper">
        <div className="mx-auto max-w-7xl px-6 py-28 lg:px-8">
          <CtaBanner
            ...
            buttons={[{ href: '/contact', label: 'Host a Station', variant: 'mint' }]}
          />
        </div>
      </Section>
    </>
